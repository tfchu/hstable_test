...
// need to add: do insertOne() if id is not found
foreach ($results as $result) {
    $collection->updateOne(
        ['_id' => new MongoDB\BSON\ObjectId($result[0]['$oid'])], 
        ['$set' => ['project' => $result[1], 'version' => $result[2], 'fw' => $result[3], 'tester' => $result[4]]]
    );
}
